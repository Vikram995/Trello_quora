...
public class UserDao {
  ...
  /**
   * Fetch a user by given id from the DB.
   *
  ...
  /**
   * This methods stores the user details in the database. This method receives the UserEntity
   * object with its attributes being set.
   */
  ...
  /**
   * This methods gets the user details based on name.
   *
   * @param userName username of the user whose information is to be fetched.
   * @return null if the user with given username doesn't exist in Database.
   */
  ...
  /**
   * This methods gets the user details based on the email.
   *
